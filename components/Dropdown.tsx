...
function Dropdown() {
    return (
        <section className='hover:shadow-lg dark:hover:shadow-md dark:hover:shadow-white flex flex-col gap-y-3 2xl:p-5 p-10 md:p-3 bg-white dark:bg-darkBg rounded-lg text-sm 2xl:text-base text-black dark:text-white'>
