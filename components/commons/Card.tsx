...
function Card({ imageUrl, title, details }: Props) {
    return (
        <div className='hover:shadow-lg flex flex-col gap-y-3 items-center justify-around text-center p-2 bg-white rounded-xl text-black/80 md:w-[200px] md:h-[250px] 2xlw-[250px] 2xl:h-[320px]'>
